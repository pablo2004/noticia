...
$data = '';
 ...
 $data .= $this->Dom->setFormSearch("Buscar Noticia", $controllerPath."buscar/", $_GET, Hash::get($_GET, 'searchAuto'));
 $data .= "<hr>";
...
/* Block */
$main = $this->Block->setMainBlock("Lista de Noticias", $data, 'fa fa-newspaper-o');
