<?php  
 ...
 $data .= $this->Dom->setFormSearch("Buscar Lista", $controllerPath."buscar/", $_GET, Hash::get($_GET, 'searchAuto'));
 $data .= "<hr>";
 ...
 /* Block */
 $main = $this->Block->setMainBlock("Lista de Items de Navegacion", $data);
