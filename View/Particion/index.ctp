<?php  
 ...
 $data .= $this->Dom->setFormSearch("Buscar Particion", $controllerPath."buscar/", $_GET, Hash::get($_GET, 'searchAuto'));
 $data .= "<hr>";
 ...
 /* Block */
 $main = $this->Block->setMainBlock("Lista de Particiones", $data);
